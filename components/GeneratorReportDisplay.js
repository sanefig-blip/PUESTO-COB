...
const GeneratorReportDisplay = ({ reportData, onUpdateReport, currentUser }) => {
                            ...
                            React.createElement("tr", { key: equip.id, className: `border-t border-zinc-700 ${isEditing && !stationIsEditable ? 'opacity-60' : 'hover:bg-zinc-700/50'}` },
                                ...
                                isEditing ? (
                                    React.createElement(React.Fragment, null,
                                        ...
                                        React.createElement("td", null, React.createElement("input", { value: equip.kva, onChange: e => handleEquipmentChange(stationIdx, equipIdx, 'kva', e.target.value), className: "w-full bg-zinc-700 rounded p-1 disabled:bg-zinc-800", disabled: !stationIsEditable })),
                                        React.createElement("td", null,
